...
//****************************************************************************************************************
#define NETWORKID     34  //the same on all nodes that talk to each other.  Using 34 for Room 34
...
// **********************************************************************************************
const byte LUCA_UID  = 0;   //unique IDs.  Allocated in order of start dates.
const byte FRED_UID  = 1;
const byte NODEID    = FRED_UID;  //change to one of the above UIDs to personalise this board
...
const char MY_STRING[] = "FRED IS FUNKY ";
// **********************************************************************************************
